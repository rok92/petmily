...
<html>
	<head>
		...
		<script src="<c:url value="/js/adminServiceNew.js"/>"></script>
	</head>
			...
			<form id="userFrm">
		    	...
		    	<div class="userInfo_box">
			        <div class="custom_info">
			        	<div class="info_box">
			            	<p class="title">구분</p>
			            	<input type="text" id="serviceSort" name="serviceSort" class="text_content" required />
			          	</div>
			          	<br>
			          	<div class="info_box">
			            	<p class="title">이름</p>
			            	<input type="text" id="serviceName" name="serviceName" class="text_content" required />
			          	</div>
		        	</div>
		    	</div>
