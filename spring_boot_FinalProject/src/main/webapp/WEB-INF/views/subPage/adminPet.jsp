...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<c:url value="/css/adminPet.css"/>">
		
		<script src="<c:url value="/js/adminPet.js"/>"></script>
	</head>
		...
		<section class="wrap">
			...
			<article>
				...
				<div class="main-layout">
					...
					<form method="post" id="userFrm" class="userFrm" name="userFrm" action="<c:url value="/adminPetSearch/0"/>">
